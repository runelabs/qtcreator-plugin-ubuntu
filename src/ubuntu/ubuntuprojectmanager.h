...
#ifndef UBUNTUPROJECTMANAGER_H
#define UBUNTUPROJECTMANAGER_H
...
class UbuntuProject;
class UbuntuProjectManager : public ProjectExplorer::IProjectManager
{
    Q_OBJECT
...
private:
    QList<UbuntuProject*> m_projects;
